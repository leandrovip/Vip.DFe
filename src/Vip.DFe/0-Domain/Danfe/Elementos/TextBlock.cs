...
namespace Vip.DFe.Danfe.Elementos
{
    ...
    internal class TextBlock : DrawableBase
    {
        ...
        public override void Draw(Gfx gfx)
        {
            ...
            {
                gfx.DrawString(item, new RectangleF(X, y, Width, _Height.Value), Fonte, AlinhamentoHorizontal);
                y += Fonte.AlturaLinha;
            }
        }
        ...
        private void CalculateLines()
        {
            ...
            for (int i = 0; i < Blocks.Count; i++) CalculateBlocks(Blocks[i], BlocksW[i]);
        ...
        private void SplitText()
        {
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                for (int i2 = 0; i2 < blocks.Length; i2++) blocksW[i2] = Fonte.MedirLarguraTexto(blocks[i2]);
