...
{
    internal static class DanfeHelper
    {
        /// <summary>
        ///     Cultura pt-BR
        /// </summary>
        ...
        private static string InternalRegexReplace(string input, string pattern, string replacement)
        {
            ...
            if (!string.IsNullOrWhiteSpace(input))
            {
                ...
                if (rgx.IsMatch(input)) result = rgx.Replace(input, replacement);
            }
        ...
        public static string FormatarEnderecoLinha1(string endereco, string numero = null, string complemento = null)
        {
            ...
            if (!string.IsNullOrWhiteSpace(endereco))
            {
                ...
                if (!string.IsNullOrWhiteSpace(complemento)) linha1 += " - " + complemento.Trim();
            }
        ...
        {
            if (cep < 0) throw new ArgumentOutOfRangeException("cep", "o cep não pode ser negativo.");
        ...
        public static string FormatarCpfCnpj(string cpfCnpj)
        {
            ...
            if (!string.IsNullOrWhiteSpace(cpfCnpj))
            {
                ...
                else if (Regex.IsMatch(result, CNPJ)) result = FormatarCnpj(result);
            }
            else
            {
                result = string.Empty;
        ...
        public static string FormatarMunicipioUf(string municipio, string uf, string separador = " - ")
        {
            ...
            else if (!string.IsNullOrWhiteSpace(uf)) result = uf.Trim();
