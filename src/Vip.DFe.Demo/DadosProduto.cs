...
namespace Vip.DFe.Demo
{
    public class DadosProduto
    {
        ...
        public NFeDetProduto GetProduto()
        {
            ...
            prod.XProd = "PRODUTO DE TESTEPRODUTO DE TESTEPRODUTO DE TESTEPRODUTO DE TESTEPRODUTO DE TESTEPRODUTO DE TESTEPRODUTO DE TESTEPRODUTO DE TESTEPRODUTO DE TESTE";
